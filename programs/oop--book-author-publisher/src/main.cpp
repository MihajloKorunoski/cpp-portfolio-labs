...
int main() {
    ...
    knigi[0]={"C++ Osnovi na programiranje",234.5,"ISBN-10",2007,"Jake Thompson",
              "Informatika","ryan@gocmar.mk","GOCMAR","Krushevska 100"};
    knigi[1]={"C++ Osnovi na degradiranje",212.5,"ISBN-10",2007,"Connor Carlson",
              "Informatika","ryan@gocmar.mk","GOCMAR","Krushevska 100"};
    knigi[2]={"Algoritmi i podatochni strukturi",4000.5,"ISBN-10",2020,"Connor Carlson",
              "Informatika","grantcollins@gocmar.mk","GOCMAR","Krushevska 100"};
